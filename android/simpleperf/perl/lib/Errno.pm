...
"MSWin32\-x64\-multi\-thread-10\.0\.22621\.3880" or
	die "Errno architecture (MSWin32\-x64\-multi\-thread-10\.0\.22621\.3880) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
